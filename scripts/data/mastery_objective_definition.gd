...
static func definitions() -> Array[MasteryObjectiveDefinition]:
	return [
		...
		create(&"fall_1_healthy_win", &"localized_focus", "Stabiler Abschluss", "Mit mindestens 50 % Zustand gewinnen.", &"final_stability_ratio", 0.5),
		...
		create(&"fall_3_safe_condition", &"severe_pneumonia", "Sicherer Verlauf", "Im gesamten Run nie unter 25 % Zustand fallen.", &"minimum_stability_ratio", 0.25),
	]
