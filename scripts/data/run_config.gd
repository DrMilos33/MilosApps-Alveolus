...
static func from_level(level: LevelDefinition, quick_run: bool = false) -> RunConfig:
	...
	config.boss_projectile_pattern = level.boss_projectile_pattern
	config.boss_projectile_turn_time_variation = level.boss_projectile_turn_time_variation
	...
	config.boss_wave_length = level.boss_wave_length
	config.boss_phase_minions = level.boss_phase_minions
	config.boss_phase_health_thresholds = level.boss_phase_health_thresholds.duplicate()
