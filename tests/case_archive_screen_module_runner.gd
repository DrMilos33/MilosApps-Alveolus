...
func _run() -> void:
	...
	_check(header_actions != null and _right_inside(header_actions, host), "Kompakte Headeraktionen bleiben rechts vollständig im Host")
	_check(back_button != null and _right_inside(back_button, host), "Campus-Navigation bleibt rechts vollständig im Host")
