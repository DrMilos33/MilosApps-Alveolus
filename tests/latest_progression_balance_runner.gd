...
func _test_boss_and_finding_contract() -> void:
	...
	_near(case_one.boss_projectile_turn_time_variation, 0.10, "Fall-1-Richtungswechsel variieren deterministisch um bis zu zehn Prozent")
	...
	_near(case_three.boss_projectile_speed_multiplier, 1.8, "Fall-3-Bossprojektile fliegen 80 Prozent schneller")
