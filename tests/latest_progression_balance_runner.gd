...
func _test_boss_and_finding_contract() -> void:
	...
	_near(case_one.boss_aura_screen_diameter_fraction, 0.40, "Fall-1-Bossaura besitzt 40 Prozent Bildschirmdurchmesser")
	_near(case_one.boss_aura_speed_multiplier, 1.30, "Fall-1-Bossaura erhöht nahes Tempo um 30 Prozent")
	_near(case_one.boss_aura_damage_multiplier, 1.30, "Fall-1-Bossaura erhöht nahen Schaden um 30 Prozent")
