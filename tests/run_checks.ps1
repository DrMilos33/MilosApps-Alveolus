...
$tests = [ordered]@{
    ...
    latest_progression_balance = @{ script = 'res://tests/latest_progression_balance_runner.gd'; args = @() }
    ...
    pressure_ai = @{ script = 'res://tests/pressure_ai_runner.gd'; args = @() }
