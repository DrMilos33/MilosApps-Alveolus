...
$groups = [ordered]@{
    ...
    Combat = @('core', 'combat', 'upgrades', 'damage_types', 'case_modifiers', 'feedback_architecture', 'lexicon_presentation', 'combat_progression', 'enemy_ranged_attack', 'treatment_aim', 'treatment_beam', 'ability_pipeline', 'tactical_flow', 'loadout_availability', 'determinism')
