...
- Upgradeicons werden über die betroffene Komponente datengetrieben aufgelöst. Breite Karten inszenieren sie als gerahmte 72-Pixel-Medaillons über dem kompakten Komponentennamen; bei 200-Prozent-UI wechselt dieselbe Karte in eine vollständige Querfassung mit 52-Pixel-Medaillon. Die UI besitzt keine ID-Mappingtabelle für zukünftige Ausbauten.
- Level-up-Karten lesen sich als Belohnungen statt als Produktkarten: Die Kartenwirkung bildet den großen zentralen Wertakzent, der Vorher-Nachher-Vergleich bleibt eine ruhige Begründungszeile und der äußere Modalträger tritt optisch hinter die drei Auswahlflächen zurück. Common, Magic und Rare behalten ihren vollständigen Seltenheitsrahmen und erhalten zusätzlich einen, zwei beziehungsweise drei kleine Raritätsdiamanten. Der ausgeschriebene Seltenheitsname bleibt im zugänglichen Kartennamen.
