...
- Das Lexikon startet als dichte Vollflächen-Galerie. Die fünf Reiter liegen ohne große Leerstufe direkt am oberen Inhaltsrand; ein fest breites Suchfeld und der Entdeckungsfortschritt teilen sich darunter eine kompakte Werkzeugzeile. Bei 1280×720 verwendet die Galerie sieben kleine Spalten. Entdeckte Kacheln zeigen ausschließlich Illustration beziehungsweise Icon und Namen ohne Kategorie- oder Unterzeile. Gesperrte Kacheln werden vollständig von der goldgerahmten Schlossmembran bedeckt und zeigen sichtbar ausschließlich ein zentrales Padlock; Name und Freischaltgrund bleiben nur im zugänglichen Namen erhalten. Klick oder `Accept` markiert einen entdeckten Eintrag dauerhaft. Auf breiten Bühnen ab 820 logischen Pixeln bleibt eine zweispaltige, 340–420 Pixel breite Mastergalerie links bedienbar, während das große Detail rechts erscheint; dessen Kopf enthält nur Icon, Namen und eine schmale Rückkehraktion. Kategorieüberschrift und Fachuntertitel belegen dort keine eigenen Zeilen. Kompaktere Bühnen verwenden weiterhin eine eindeutige Detail-Zweitebene. Maus-Hover, reiner Fokus und Suche verändern weder Auswahl noch Detail; `Cancel` schließt zuerst das Detail und kehrt in die unveränderte Galerie zurück.
