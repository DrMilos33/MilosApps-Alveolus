...
| D-038 | Spielernahe Aktivfähigkeitstexte nennen knapp und direkt die mechanische Wirkung; der verständliche Begriff lautet `Kontaktschaden` statt `Kontaktdruck`. Die behandelnde Figur heißt durchgängig „Doctor Milos“, und das Laufzeitmenü trägt den kompakten Titel „☕ Pause“. |
